        ...
        <div class="row-fluid">
            ...
            <div class="span12 widget">
                ...
                <div class="widget-content form-container">
                    <form class="form-vertical" id="{pageContent}" action="{site_url}admin/{pageContent}/action" method="post" novalidate="novalidate">
                       <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea id="cleditor" name="desc">{desc}</textarea>
                            </div>
                        </div>
