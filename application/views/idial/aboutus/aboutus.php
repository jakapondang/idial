<div class="container">
    ...
    <div class="row">
        ...
        <div class="span4">
            <img src="<?php print $mbaseurl?>image/banner2.jpg" alt="banner1" class="img-polaroid">
        </div>
        <div class="span4">
            <img src="<?php print $mbaseurl?>image/banner3.jpg" alt="banner2" class="img-polaroid">
        </div>
    </div>
