    ...
    <div class="footer2 container">
        <div class="row">
            <div class="span12 faddress" style="text-align: center">
                <a href="https://twitter.com/iDial_Corner" target="_blank">LIKE US <img src="<?php print $mbaseurl; ?>img/facebook-iDial.png" width="50px"></a>
            <img src="<?php print $mbaseurl; ?>img/bestprice1.png" width="70px">
            <a href="https://www.facebook.com/iDial.Shop" target="_blank"><img src="<?php print $mbaseurl; ?>img/twitter-iDial.png" width="50px"> FOLLOW US</a>
            </div>
        </div>
   </div>
