...
<head>
    ...
    <title>iDialCorner.com | <?php print $ksearch ?></title>
    ...
    <meta name="keywords" content="harga <?php print $ksearch ?> ,price list <?php print $ksearch?>,<?php print $ksearch?> jakarta,<?php print $ksearch ?> murah,jual <?php print $ksearch?>,<?php print $ksearch ?> second" />
    ...
    <meta property="og:description" content="harga <?php print $ksearch ?> ,price list <?php print $ksearch?>,<?php print $ksearch?> jakarta,<?php print $ksearch ?> murah,jual <?php print $ksearch?> ,<?php print $ksearch ?> second"/>
